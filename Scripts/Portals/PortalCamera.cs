...
public class PortalCamera : MonoBehaviour
{
    ...
    private RenderTexture[] tempTextures;
    ...
    private void Awake()
    {
        ...
        tempTextures = new RenderTexture[portals.Length];
    ...
    void UpdateCamera(ScriptableRenderContext SRC, Camera camera)
    {
        ...
        //
        //    RenderCamera(portals[0], portals[1], SRC);
        //
        //}
        //
        ...
        //
        //    RenderCamera(portals[1], portals[0], SRC);
        ...
        for (int i = 0; i < portals.Length ; i++)
        {
            if (portals[i].Renderer.isVisible)
            {
                ...
                //{
                    RenderCamera(portals[i], portals[i].OtherPortal, SRC);
                //}
            }
        }
    }
